...
<?php
  ...
  //  }
    ...
    $Status = "Pending");
    $stmt->execute();
    if (!empty($manager_first_name) ){
    session_start();
    $_SESSION['manager_first_name'] = $manager_first_name;
   $_SESSION['manager_last_name'] = $manager_last_name;

    header('Location:http://localhost/test/manager_homepage.html.php');
  }
